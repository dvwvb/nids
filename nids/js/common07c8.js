...
if ($.exists('.custom-select-box .custom-select')) {
	$(".custom-select-box .custom-select").each(function() {
		...
		if ($.exists(".custom-select-box.has-optgroup")) {
			$(this).find("optgroup").each(function() {
				var optgroup_tit_txt = $(this).attr("label");
				template += '<li class="custom-option-item option-tit" data-label="' + $(this).attr("label") + '">' + optgroup_tit_txt + "</li>";
	...
	$(".custom-select-trigger").on("click", function(event) {
		...
		if ($.exists(".custom-select-box.has-optgroup")) {
			customScrollY(".custom-option-drop-list");
		}
...
$(document).ready(function  () {
	...
	* 탭 전환
	************************ */
	var swiperGnb = new Swiper('.prd-gnb-wrapper', {
		slidesPerView: 'auto',
...
function followMousePointer () {
	...
	$("body").on('mousemove', function (e){
		$mouse_follow_btn.addClass("active");
	...
	$("a, button")
		.on('mouseenter', function (e){
			$mouse_follow_btn.addClass("hover");
		})
		.on('mouseleave', function (e){
			$mouse_follow_btn.removeClass("hover");
		})
