                            ...
                            <div class="area">
                                ...
                                <article class="bbs-view-con">
                                    <aside class="bbs-view-top">
                                        ...
                                        <!-- // -->
                                        <h1 class="bbs-tit">2023 상반기 엔아이디에스 경력사원 공개채용</h1>
                                    ...
                                    <div class="bbs-view-content editor">
                                        <p>2023 상반기 엔아이디에스 경력사원 공개채용<br></p>
                                    </div>
		...
		<ul>
			...
			<li style="background-color:#dc4e41;"><a href="" title="구글에 공유하기"><i class="xi-google-plus"></i></a></li>
                                    ...
                                    <form method="post" action="#" name="form2">
                                        <input type="hidden" name="code" value="recruit_nids">
                                        <input type="hidden" name="bbs_view_del" value="1">
                                        <input type="hidden" name="bbs_view_edit" value="1">
                                        <input type="hidden" name="returnURL" value="/nids/kr/customer/recruit.php">
                                    </form>

                                    <div class="cm-btn-controls">
                                        <div class="right-btn-controls">
                                            <a href="recruit.html#recruit" class="btn-style01">
                                                목록 </a>
                                        </div>
                                    </div>
                                                ...
                                                <table class="bbs-prev-next-tbl">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="recruitdaff.html?code=recruit_nids&amp;idx=18&amp;bgu=view">
                                                                    <p class="bbs-tit">2023 상반기 엔아이디에스 경력사원 공개채용</p>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                    ...
                                    <script type="text/javascript">
                                        function dele() {
                                            ...
                                            if (ans == true) {
                                                form2.action = "https://www.nids.co.kr/bbs/bbs_view_del.php?returnURL=&amp;idx=17";
                                                form2.submit();
                                            }
                                        }

                                        function modi() {
                                            form2.action = "recruitd6c8.html?returnURL=&amp;bgu=edit&amp;idx=17";
                                            form2.submit();
                                        }
                                    </script>
